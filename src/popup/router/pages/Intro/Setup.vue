<template>
  <div class="settings">
    <h4>Manually Connect to Your MIR.Cube Node</h4>
    <p class="help-text">
    ...
    <p v-if="error" class="report-error">
      Connection unsuccessful. Please try again or <a class="help-link" href="https://mir.one/node-help/" target="_blank" rel="noopener">See Our Guide</a>
    </p>
  </div>
</template>
