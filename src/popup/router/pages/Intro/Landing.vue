<template>
  <div class="overlay container">
    <div class="overlay_inner">
      ...
      <div class="buttons">
        <a class="btn btn-block default-button" name="button" href="https://mir.one/lightning-node/" target="_blank" rel="noopener">Get a MIR.Cube Node for $499</a>
        <a class="btn btn-block mir-button" name="button" @click.prevent="enter">Connect Your MIR.Cube Node</a>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    enter() {
      ...
      if (baseUrl.indexOf('mir-node.local') || ipRegex.test(baseUrl)) {
