  ...
  <div class="overlay container h-100">
    <div class="overlay_inner">
      ...
      <div class="overlay-buttons">
        <a class="btn mir-button btn-outline btn-block" name="button" @click.prevent="$router.push('/bitcoin/send/receipt')">View Receipt</a>
        <a class="btn mir-button btn-white btn-block" name="button" href="#" aria-label="close" @click.prevent="$router.push('/bitcoin')">Done</a>
      </div>
    </div>
  </div>
</template>
