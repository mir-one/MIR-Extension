    ...
    <main class="popup-main">
      <div class="overlay_inner">
        ...
        <section class="copy-request">
          <p>{{ address }}</p>
          <a v-if="!copied" type="button" class="btn mir-button" v-clipboard:copy="address" v-clipboard:success="onCopy" v-clipboard:error="onError">Copy</a>
          <a v-if="copied" type="button" class="btn mir-button" v-clipboard:copy="address" v-clipboard:success="onCopy" v-clipboard:error="onError">
        ...
        <a class="btn mir-button btn-block btn-done" href="#" aria-label="close" @click.prevent="$router.push('/lightning')">Done</a>
      </div>
    </main>
  </div>
</template>
