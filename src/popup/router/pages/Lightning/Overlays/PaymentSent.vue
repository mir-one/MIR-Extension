  ...
  <div class="overlay container h-100">
    <div class="overlay_inner">
      ...
      <div class="overlay-buttons">
        <a class="btn mir-button btn-outline btn-block" name="button" @click.prevent="$router.push('/lightning/channels/new')">Open Channel</a>
        <a class="btn mir-button btn-white btn-block" name="button" href="#" aria-label="close" @click.prevent="$router.push('/lightning')">Done</a>
      </div>
    </div>
  </div>
</template>
...
a.btn.mir-button.btn-outline.btn-block {
  margin-bottom: 1rem;
}
