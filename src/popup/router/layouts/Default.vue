<template>
  <div class="popup-container">
    ...
    <footer class="footer">
      <div class="container">
        <a href="https://mir.one/node-help/" target="_blank" rel="noopener">Help</a>
        <a class="btn ext-link" :href="baseUrl" target="_blank" rel="noopener"> <strong>Go To MIR.Cube Node</strong> <img src="~assets/images/chevron.svg" /> </a>
      </div>
    </footer>
  </div>
</template>
